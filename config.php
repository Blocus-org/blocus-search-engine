<?php
    return (object) array(
        ...
        "google_language_site" => "fr",
        "google_language_results" => "fr",

        // You can set a language for results in wikipedia
        "wikipedia_language" => "fr",

        // You can use any Invidious instance here
        "invidious_instance_for_video_results" => "http://not-ytb.blocus.ch",
        ...
        */
        ...
        "frontends" => array(
            "invidious" => array(
                "instance_url" => "http://not-ytb.blocus.ch",
                "project_url" => "https://github.com/Zqfd", 
