...
<title>
<?php
  $query = htmlspecialchars(trim($_REQUEST["q"]));echo $query;?> - Blocus</title>
</head>
    <body>
            ...
            switch ($type)
            {
                ...
                case 4:
                    ...
                    else
                    {
                        ...
                        echo '<div class="tor_msg"><span>You need to be connected to the <a class="tor_link" href="https://www.torproject.org/about/history/">Tor</a> onion network to visit these sites.<br/> If you don\'t know what you\'re doing here, you need to read this <a href="tor-advice.php">advice</a> and then use a <a href="https://wiki.froth.zone/wiki/Virtual_private_network">VPN</a> before doing anything!<br/></span></div>';
                        print_elapsed_time($start_time);
